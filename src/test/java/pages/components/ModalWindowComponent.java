...
private final static SelenideElement  userInformationTable = $(".table-responsive"),
...
public static void checkModalWindowTitle(String value){
  tableTitle.shouldHave(text(value));
}

public static void checkShortUserData(String rowName, String rowValue){
  userInformationTable.$(byText(rowName)).parent().shouldHave(text(rowValue));
}

public static void userInformationTableShouldNotBeVisible(){
  userInformationTable.shouldNotBe(visible);
}

public static void checkFullUserData(String studentName,
